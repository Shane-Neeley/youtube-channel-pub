...
class DecisionTree(object):
    ...
    def _build_model(self):
        ...
        # do grid search over HYPERPARAMETERS depth range to find the best
        self.model = GridSearchCV(DecisionTreeClassifier(), parameters, n_jobs=4)
    ...
    def train(self, **kwargs):
        ...
        self.model.fit(X, Y)
        tree_model = self.model.best_estimator_
        print(self.model.best_score_, self.model.best_params_)
        # Save model
        dump(tree_model, './logs/model_' + self.mname + '.joblib')
