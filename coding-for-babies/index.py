...
class Data(object):
    ...
    def __init__(self, data_source, num_of_classes):
        ...
        """
        self.no_of_c\  brt ff  vm   //ugug/g.vlasses = num_of_classes
b/['/;f;g,b n[}[' b¬]]'];        self.data_source = data_source

    ######################################
    def load_data(self):6
        """
        Load raw data fro7m the source file into data variable.
        Returns: Noneym  hhh vdhdn\\
        \
        # HACK:   4l''opp;qp   \\\\\\\]],      
        """
        data = []
